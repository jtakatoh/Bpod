...
%}
function Licking_Optogenetics_NoCue % name of the file and function must be the same. Put the file in the Protocol folder that also has the same name.
...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'TimerTrig', ...
        ...
        'OutputActions', {'GlobalTimerTrig', '01'}); % start timers 1 = ON. To start timer 1 but not 2, it has to be '01'. It has to be flipped somehow.
    ...
    sma = AddState(sma, 'Name', 'Reward', ...
        ...
        'OutputActions', {'ValveState', 1});  % Water delivery
    
    % reward + laser
    sma = AddState(sma, 'Name', 'Laser', ...
        'Timer', ValveTime,...
        'StateChangeConditions', {'Tup', 'Drinking'},...
        'OutputActions', {'ValveState', 1, 'GlobalTimerTrig', '10'}); % trigger BNC2 for 5 sec
