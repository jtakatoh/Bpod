...
% A successful trial take around 12.2 ~ 22.2 seconds. 
%%
global BpodSystem
...
if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
    ...
    S.GUI.SoundIntensity = 0.5; % Intensity of the sound, range between 0 1. 70db is good. 
    S.GUI.ResponseWindow = 10; % Response time window in seconds
    S.GUI.LickThreshold = 3; % Number of licks required to deliver reward
...
for currentTrial = 1:S.GUI.MaxTrials
    ...
    sma = AddState(sma, 'Name', 'UnconditionedReward', ...
        ...
        'OutputActions', {'ValveState', 1, 'HiFi1', 2});
